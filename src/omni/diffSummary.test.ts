...
describe('toDiffHunks', () => {
  ...
  it('passes through a normal line change unchanged', () => {
    const hunks = toDiffHunks([
      { originalStartLineNumber: 3, originalEndLineNumber: 5, modifiedStartLineNumber: 3, modifiedEndLineNumber: 4 } as any,
    ]);
    expect(hunks).toEqual([
      { originalStartLineNumber: 3, originalEndLineNumber: 5, modifiedStartLineNumber: 3, modifiedEndLineNumber: 4 },
    ]);
  });

  it('falls back originalEndLineNumber to originalStartLineNumber for a pure insertion (Monaco reports 0)', () => {
    const hunks = toDiffHunks([
      { originalStartLineNumber: 5, originalEndLineNumber: 0, modifiedStartLineNumber: 5, modifiedEndLineNumber: 7 } as any,
    ]);
  ...
  it('falls back modifiedEndLineNumber to modifiedStartLineNumber for a pure deletion (Monaco reports 0)', () => {
    const hunks = toDiffHunks([
      { originalStartLineNumber: 5, originalEndLineNumber: 7, modifiedStartLineNumber: 5, modifiedEndLineNumber: 0 } as any,
    ]);
...
describe('summarizeDiff', () => {
  ...
  it('recognizes added kernel args', () => {
    ...
    const hunks = [{ originalStartLineNumber: 3, originalEndLineNumber: 3, modifiedStartLineNumber: 3, modifiedEndLineNumber: 4 }];
  ...
  it('recognizes removed kernel args', () => {
    ...
    const hunks = [{ originalStartLineNumber: 2, originalEndLineNumber: 3, modifiedStartLineNumber: 1, modifiedEndLineNumber: 1 }];
  ...
  it('recognizes KubeSpan changes regardless of added/removed', () => {
    ...
    // own.
    const hunks = [{ originalStartLineNumber: 1, originalEndLineNumber: 2, modifiedStartLineNumber: 1, modifiedEndLineNumber: 2 }];
  ...
  it('recognizes the machine selector via match_labels (MachineClass JSON shape)', () => {
    ...
    const hunks = [{ originalStartLineNumber: 2, originalEndLineNumber: 2, modifiedStartLineNumber: 2, modifiedEndLineNumber: 2 }];
  ...
  it('recognizes added labels', () => {
    ...
    const hunks = [{ originalStartLineNumber: 1, originalEndLineNumber: 1, modifiedStartLineNumber: 2, modifiedEndLineNumber: 3 }];
  ...
  it('joins multiple distinct recognized patterns into one sentence', () => {
    ...
    const modified = ['machine:', '  install:', '    extraKernelArgs:', '      - foo', '  network:', '    kubespan:', '      enabled: true'];
    const hunks = [{ originalStartLineNumber: 1, originalEndLineNumber: 1, modifiedStartLineNumber: 2, modifiedEndLineNumber: 7 }];
    ...
    expect(summarizeDiff(hunks, original, modified)).toBe('Adds kernel args, changes KubeSpan settings.');
  });
  ...
  it('deduplicates the same recognized pattern touched by multiple hunks', () => {
    ...
    const hunks = [
      { originalStartLineNumber: 1, originalEndLineNumber: 0, modifiedStartLineNumber: 2, modifiedEndLineNumber: 3 },
      { originalStartLineNumber: 2, originalEndLineNumber: 1, modifiedStartLineNumber: 5, modifiedEndLineNumber: 6 },
    ];
    expect(summarizeDiff(hunks, original, modified)).toBe('Adds labels.');
  });
  ...
  it('falls back to a singular line-count description for one unrecognized changed line', () => {
    ...
    const hunks = [{ originalStartLineNumber: 1, originalEndLineNumber: 1, modifiedStartLineNumber: 1, modifiedEndLineNumber: 1 }];
  ...
  it('counts a changed-line range as the max of removed/added line counts', () => {
    ...
    const modified = ['a: 2'];
    const hunks = [{ originalStartLineNumber: 1, originalEndLineNumber: 3, modifiedStartLineNumber: 1, modifiedEndLineNumber: 1 }];
